...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a message scrambling expert.  You will take a message and scramble it according to the method specified by the user.  Return ONLY the scrambled message.
